...
9. Run Redis in Docker:
To install and start Redis locally using Docker, use the following command: `docker run -d --name redis -p 6379:6379 redis`
10. Run the development server with HTTPS: To run the server with HTTPS, use the following command:
...
11. Access the app at https://127.0.0.1:8000/ in your browser.
